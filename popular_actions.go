...
var PopularActions = map[string]*ActionMetadata{
	...
	"JamesIves/github-pages-deploy-action@v4": {
		...
		Inputs: ActionMetadataInputs{
			"attempt-limit":    {"attempt-limit", false},
			"branch":           {"branch", false},
			"clean":            {"clean", false},
	...
	"ReactiveCircus/android-emulator-runner@v2": {
		...
		Inputs: ActionMetadataInputs{
			...
			"system-image-api-level":     {"system-image-api-level", false},
			"target":                     {"target", false},
	...
	"Swatinem/rust-cache@v2": {
		...
		Inputs: ActionMetadataInputs{
			...
			"cache-workspace-crates": {"cache-workspace-crates", false},
	...
	"actions/setup-node@v4": {
		...
		Inputs: ActionMetadataInputs{
			...
			"check-latest":          {"check-latest", false},
			"mirror":                {"mirror", false},
			"mirror-token":          {"mirror-token", false},
	...
	"actions/setup-python@v5": {
		...
		Inputs: ActionMetadataInputs{
			...
			"cache-dependency-path": {"cache-dependency-path", false},
			"check-latest":          {"check-latest", false},
			"freethreaded":          {"freethreaded", false},
	...
	"azure/aks-set-context@v4": {
		...
		Inputs: ActionMetadataInputs{
			...
			"resource-type":  {"resource-type", false},
	...
	"codecov/codecov-action@v5": {
		...
		Inputs: ActionMetadataInputs{
			...
			"disable_safe_directory":     {"disable_safe_directory", false},
			"disable_search":             {"disable_search", false},
			"disable_telem":              {"disable_telem", false},
			"dry_run":                    {"dry_run", false},
			"env_vars":                   {"env_vars", false},
			"exclude":                    {"exclude", false},
			"fail_ci_if_error":           {"fail_ci_if_error", false},
			...
			"override_pr":                {"override_pr", false},
			"plugins":                    {"plugins", false},
			"recurse_submodules":         {"recurse_submodules", false},
			"report_code":                {"report_code", false},
	...
	"erlef/setup-beam@v1": {
		...
		Inputs: ActionMetadataInputs{
			...
			"otp-architecture":         {"otp-architecture", false},
	...
	"github/codeql-action/init@v3": {
		...
		Inputs: ActionMetadataInputs{
			...
			"matrix":                    {"matrix", false},
			"packs":                     {"packs", false},
			"quality-queries":           {"quality-queries", false},
	...
	"pulumi/actions@v6": {
		...
		Inputs: ActionMetadataInputs{
			...
			"edit-pr-comment":        {"edit-pr-comment", false},
			"exclude":                {"exclude", false},
			"exclude-dependents":     {"exclude-dependents", false},
			"exclude-protected":      {"exclude-protected", false},
			"expect-no-changes":      {"expect-no-changes", false},
			"github-token":           {"github-token", false},
			"log-flow":               {"log-flow", false},
			"log-verbosity":          {"log-verbosity", false},
			"message":                {"message", false},
			"parallel":               {"parallel", false},
			"plan":                   {"plan", false},
			"policypackconfigs":      {"policyPackConfigs", false},
